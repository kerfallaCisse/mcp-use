...
class MCPWebServer:
    ...
    async def handle_request_with_dynamic_payload(self, request_body: RequestBody) -> str:
        ...
        """
        print(
            f"📝 Processing query (dynamic payload): {request_body.query[:50]}...")
...
async def simulate_web_requests():
    ...
    test_requests = [
        ...
        RequestBody(
            ...
            payload={
                "auth_token": "another_token_abc123",
                "user_id": "user789"
            }
        ),
        RequestBody(
